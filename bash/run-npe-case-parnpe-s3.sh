...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w wdir$1 -parnpe -cp" | tee rdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w wdir$1 -parnpe" | tee rdir$1/repair.log
mv __patch* rdir$1/
tar czf npe-parnpe-caseno$1.tar.gz wdir$1 rdir$1
s3cmd put -f npe-parnpe-caseno$1.tar.gz $2
