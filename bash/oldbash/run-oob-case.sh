...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-oob -skip-init -w oobwdir$1 -s oob-space/space.txt -c oob-space/candidate -cp" | tee oobrdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-oob -skip-init -w oobwdir$1 -s oob-space/space.txt -c oob-space/candidate" | tee oobrdir$1/repair.log
