...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -s cce-space-vo/space.txt -c cce-space-vo/candidate -cp" | tee ccerdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -s cce-space-vo/space.txt -c cce-space-vo/candidate" | tee ccerdir$1/repair.log
mv __patch* ccerdir$1/
tar czf cce-alt-caseno$1.tar.gz ccewdir$1 ccerdir$1
s3cmd put -f cce-alt-caseno$1.tar.gz $2
