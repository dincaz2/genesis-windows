...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -parcce -cp" | tee ccerdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -parcce" | tee ccerdir$1/repair.log
mv __patch* ccerdir$1/
tar czf cce-parcce-caseno$1.tar.gz ccewdir$1 ccerdir$1
s3cmd put -f cce-parcce-caseno$1.tar.gz $2
