...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w oobwdir$1 -s any-space-tv/space.txt -c any-space-tv/candidate -cp" | tee oobrdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w oobwdir$1 -s any-space-tv/space.txt -c any-space-tv/candidate" | tee oobrdir$1/repair.log
mv __patch* oobrdir$1/
tar czf oob-any-caseno$1.tar.gz oobwdir$1 oobrdir$1
s3cmd put -f oob-any-caseno$1.tar.gz $2
