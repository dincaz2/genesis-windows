...
mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -s any-space-tv/space.txt -c any-space-tv/candidate -cp" | tee ccerdir$1/patch_count.log
timeout 5h mvn exec:java -Dexec.mainClass="genesis.repair.Main" -Dexec.args="-skip-init -w ccewdir$1 -s any-space-tv/space.txt -c any-space-tv/candidate" | tee ccerdir$1/repair.log
mv __patch* ccerdir$1/
tar czf cce-any-caseno$1.tar.gz ccewdir$1 ccerdir$1
s3cmd put -f cce-any-caseno$1.tar.gz $2
