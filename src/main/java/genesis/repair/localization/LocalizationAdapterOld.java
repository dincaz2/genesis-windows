...
public class LocalizationAdapterOld implements DefectLocalization {
	
	WorkdirManager manager;

	public LocalizationAdapterOld(WorkdirManager manager) {
...
//		String dbguerOutput = workingDir + "/output.csv"; // TODO: get real csv output from dbguer
	...
	public List<SuspiciousMethod> parseDiagnosticFile(String diagnosticFile) {
