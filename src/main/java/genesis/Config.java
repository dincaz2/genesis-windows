...
public class Config {
	...
	public static final String dbguerPath;
	...
	static {
		...
		tmpargfile = p.getProperty("tmp_arg_file", "C:/temp/args.log");
		tmpTestinfoFile = p.getProperty("tmp_testinfo_file", "C:/temp/testinfo.log");
		...
		tmpDirectory = p.getProperty("tmp_dir", "C:/temp");
		...
		dbguerPath = p.getProperty("dbguer_path", null);
