...
public class SerilizationTest extends TestCase
{
    ...
    public void test()
    {
    	...
    	try 
    	{
    		ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("C:/temp/tmp.po"));
    		n.writeToStream(os);
    		os.close();
    		ObjectInputStream is = new ObjectInputStream(new FileInputStream("C:/temp/tmp.po"));
